...
def get_data(args):
    ...
    # pretrained vectors
    vectors = Vectors(name="wv_model_30.pt")
    ...
    if  args.data_type == "koen":
        ...
        src.build_vocab(train.src, train.trg, min_freq=args.min_freq)
        trg.build_vocab(train.src, train.trg, min_freq=args.min_freq)

        src.vocab.set_vectors(vectors.stoi, vectors.vectors, vectors.dim)
        trg.vocab.set_vectors(vectors.stoi, vectors.vectors, vectors.dim)
